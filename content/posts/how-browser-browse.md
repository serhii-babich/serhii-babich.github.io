...
Спробую максимально просто пояснити процес відображення фінальної картинки. Отже, прямо під час завантаження HTML-файлу, браузер будує так зване DOM-дерево, яке репрезентує собою структуру документа, які частини знаходяться поруч, які вкладені, і т.д. Коли під час побудови цього DOM-дерева браузер натикається на посилання на інші ресурси, як то файли CSS, JS, чи медіа, він зазвичай відкладає усі справи в сторону, тобто ставить на паузу побудову DOM, вантажить такий ресурс і починає обробляти його.
